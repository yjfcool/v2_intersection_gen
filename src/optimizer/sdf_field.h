...
class SDFField {
public:
    void build(const BoundingBox2d&,const std::vector<Obstacle>&,
               double cs=0.2,double buf=0.0);
    void buildFromPolygons(const BoundingBox2d&,const std::vector<Polygon2d>&,
                           double cs=0.2);
...
private:
    double cs_=0.2;BoundingBox2d roi_;int rows_=0,cols_=0;
